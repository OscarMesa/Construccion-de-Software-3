...
public interface ICrud {
     ...
     * conexion externa, con el fin de que no la cierren desde los mÃ©todos de esta clase
     * @param Conexion 
     */
    ...
    /**
     * Obtiene el nÃºmero de filas que trae la consulta. <br/> Solo trae
     * informaciÃ³n cuando los mÃ©todos
     * {@linkplain ICrud#set_Cantidad(int) } y {@linkplain ICrud#set_Posicion(int)
     * } devuelven valores mayores a cero
     *
     * @return Un nÃºmero entero con la cantidad total de registros que trae la
     * consulta
